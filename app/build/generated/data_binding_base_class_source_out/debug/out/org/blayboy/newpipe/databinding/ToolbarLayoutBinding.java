...
public final class ToolbarLayoutBinding implements ViewBinding {
  ...
  public static ToolbarLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearLayout toolbarContainer = (LinearLayout) rootView;

      id = R.id.toolbar_search_container;
      View toolbarSearchContainer = rootView.findViewById(id);
      ...
      return new ToolbarLayoutBinding((LinearLayout) rootView, toolbar, toolbarContainer,
