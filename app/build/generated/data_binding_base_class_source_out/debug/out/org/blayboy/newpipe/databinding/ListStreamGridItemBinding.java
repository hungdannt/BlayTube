...
public final class ListStreamGridItemBinding implements ViewBinding {
  ...
  private ListStreamGridItemBinding(@NonNull RelativeLayout rootView,
      @NonNull TextView itemAdditionalDetails, @NonNull TextView itemDurationView,
      @NonNull AnimatedProgressBar itemProgressView, @NonNull RelativeLayout itemRoot,
  ...
  public static ListStreamGridItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListStreamGridItemBinding((RelativeLayout) rootView, itemAdditionalDetails,
