...
import org.blayboy.newpipe.fragments.list.BaseListFragment;
...
import org.blayboy.newpipe.database.history.model.SearchHistoryEntry;
import org.blayboy.newpipe.databinding.FragmentSearchBinding;
import org.blayboy.newpipe.error.ErrorActivity;
import org.blayboy.newpipe.error.ErrorInfo;
import org.blayboy.newpipe.error.ReCaptchaActivity;
import org.blayboy.newpipe.error.UserAction;
...
public class SearchFragment extends BaseListFragment<SearchInfo, ListExtractor.InfoItemsPage<?>>
    ...
    public void onResume() {
        ...
        disposables.add(ExtractorHelper.showMetaInfoInTextView(metaInfo == null ? null : Arrays.asList(metaInfo),
    ...
    public void handleResult(@NonNull final SearchInfo result) {
        ...
        disposables.add(ExtractorHelper.showMetaInfoInTextView(result.getMetaInfo(),
                searchBinding.searchMetaInfoTextView, searchBinding.searchMetaInfoSeparator));
