...
import org.blayboy.newpipe.info_list.InfoListAdapter;
...
import org.blayboy.newpipe.util.SavedState;
import org.blayboy.newpipe.util.StateSaver;
import org.blayboy.newpipe.util.StreamDialogEntry;
import org.blayboy.newpipe.views.SuperScrollLayoutManager;
import org.blayboy.newpipe.R;
import org.blayboy.newpipe.databinding.PignateFooterBinding;
import org.blayboy.newpipe.error.ErrorActivity;
...
import static org.blayboy.newpipe.ktx.ViewUtils.animateHideRecyclerViewAllowingScrolling;

public abstract class BaseListFragment<I, N> extends BaseStateFragment<I>
        implements ListViewContract<I, N>, StateSaver.WriteRead,
        SharedPreferences.OnSharedPreferenceChangeListener {
    private static final int LIST_MODE_UPDATE_FLAG = 0x32;
    protected org.blayboy.newpipe.util.SavedState savedState;
