package org.blayboy.newpipe.fragments.list.channel;
...
import org.blayboy.newpipe.local.subscription.SubscriptionManager;
import org.blayboy.newpipe.player.playqueue.ChannelPlayQueue;
...
import org.blayboy.newpipe.database.subscription.SubscriptionEntity;
import org.blayboy.newpipe.databinding.ChannelHeaderBinding;
import org.blayboy.newpipe.databinding.FragmentChannelBinding;
...
import static org.blayboy.newpipe.ktx.TextViewUtils.animateTextColor;
import static org.blayboy.newpipe.ktx.ViewUtils.animate;
import static org.blayboy.newpipe.ktx.ViewUtils.animateBackgroundColor;
...
public class ChannelFragment extends BaseListInfoFragment<ChannelInfo>
    ...
    public void showLoading() {
        ...
        BaseFragment.IMAGE_LOADER.cancelDisplayTask(headerBinding.channelBannerImage);
        BaseFragment.IMAGE_LOADER.cancelDisplayTask(headerBinding.channelAvatarView);
        BaseFragment.IMAGE_LOADER.cancelDisplayTask(headerBinding.subChannelAvatarView);
        animate(headerBinding.channelSubscribeButton, false, 100);
    }
    ...
    public void handleResult(@NonNull final ChannelInfo result) {
        ...
        BaseFragment.IMAGE_LOADER.displayImage(result.getBannerUrl(), headerBinding.channelBannerImage,
                ImageDisplayConstants.DISPLAY_BANNER_OPTIONS);
        BaseFragment.IMAGE_LOADER.displayImage(result.getAvatarUrl(), headerBinding.channelAvatarView,
                ImageDisplayConstants.DISPLAY_AVATAR_OPTIONS);
        BaseFragment.IMAGE_LOADER.displayImage(result.getParentChannelAvatarUrl(),
