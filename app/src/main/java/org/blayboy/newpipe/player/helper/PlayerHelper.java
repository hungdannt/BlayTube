...
import static org.blayboy.newpipe.player.Player.IDLE_WINDOW_FLAGS;
import static org.blayboy.newpipe.player.Player.PLAYER_TYPE;
import static org.blayboy.newpipe.player.helper.PlayerHelper.AutoplayType.AUTOPLAY_TYPE_ALWAYS;
import static org.blayboy.newpipe.player.helper.PlayerHelper.AutoplayType.AUTOPLAY_TYPE_NEVER;
import static org.blayboy.newpipe.player.helper.PlayerHelper.AutoplayType.AUTOPLAY_TYPE_WIFI;
...
public final class PlayerHelper {
    ...
    public static MainPlayer.PlayerType retrievePlayerTypeFromIntent(final Intent intent) {
        ...
        return MainPlayer.PlayerType.values()[
                intent.getIntExtra(Player.PLAYER_TYPE, MainPlayer.PlayerType.VIDEO.ordinal())];
    }
