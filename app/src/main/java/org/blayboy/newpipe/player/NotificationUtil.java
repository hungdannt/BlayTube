    ...
    private synchronized NotificationCompat.Builder createNotification(final Player player) {
        ...
        builder.setStyle(new androidx.media.app.NotificationCompat.MediaStyle()
                ...
                .setDeleteIntent(PendingIntent.getBroadcast(player.getContext(), NOTIFICATION_ID,
                        new Intent(MainPlayer.ACTION_CLOSE), FLAG_UPDATE_CURRENT));
        ...
        switch (selectedAction) {
            case NotificationConstants.PREVIOUS:
                return getAction(player, baseActionIcon,
                        R.string.exo_controls_previous_description, MainPlayer.ACTION_PLAY_PREVIOUS);

            case NotificationConstants.NEXT:
                return getAction(player, baseActionIcon,
                        R.string.exo_controls_next_description, MainPlayer.ACTION_PLAY_NEXT);

            case NotificationConstants.REWIND:
                return getAction(player, baseActionIcon,
                        R.string.exo_controls_rewind_description, MainPlayer.ACTION_FAST_REWIND);

            case NotificationConstants.FORWARD:
                return getAction(player, baseActionIcon,
                        R.string.exo_controls_fastforward_description, MainPlayer.ACTION_FAST_FORWARD);
            ...
            case NotificationConstants.PLAY_PAUSE:
                if (player.getCurrentState() == Player.STATE_COMPLETED) {
                    return getAction(player, R.drawable.ic_replay,
                            R.string.exo_controls_pause_description, MainPlayer.ACTION_PLAY_PAUSE);
                    ...
                    return getAction(player, R.drawable.exo_notification_play,
                            R.string.exo_controls_play_description, MainPlayer.ACTION_PLAY_PAUSE);
                }

            case NotificationConstants.REPEAT:
                if (player.getRepeatMode() == REPEAT_MODE_ALL) {
                    return getAction(player, R.drawable.exo_media_action_repeat_all,
                            R.string.exo_controls_repeat_all_description, MainPlayer.ACTION_REPEAT);
                } else if (player.getRepeatMode() == REPEAT_MODE_ONE) {
                    return getAction(player, R.drawable.exo_media_action_repeat_one,
                            R.string.exo_controls_repeat_one_description, MainPlayer.ACTION_REPEAT);
                } else /* player.getRepeatMode() == REPEAT_MODE_OFF */ {
                    return getAction(player, R.drawable.exo_media_action_repeat_off,
                            R.string.exo_controls_repeat_off_description, MainPlayer.ACTION_REPEAT);
                }

            case NotificationConstants.SHUFFLE:
                if (player.getPlayQueue() != null && player.getPlayQueue().isShuffled()) {
                    return getAction(player, R.drawable.exo_controls_shuffle_on,
                            R.string.exo_controls_shuffle_on_description, MainPlayer.ACTION_SHUFFLE);
                } else {
                    return getAction(player, R.drawable.exo_controls_shuffle_off,
                            R.string.exo_controls_shuffle_off_description, MainPlayer.ACTION_SHUFFLE);
                }

            case NotificationConstants.CLOSE:
                return getAction(player, R.drawable.ic_close,
                        R.string.close, MainPlayer.ACTION_CLOSE);
