...
import org.blayboy.newpipe.databinding.ActivityPlayerQueueControlBinding;
...
import static org.blayboy.newpipe.util.ShareUtils.shareText;
...
public final class PlayQueueActivity extends AppCompatActivity
    ...
    private void buildItemPopupMenu(final PlayQueueItem item, final View view) {
        ...
        share.setOnMenuItemClickListener(menuItem -> {
            ShareUtils.shareText(getApplicationContext(), item.getTitle(), item.getUrl());
            return true;
        });
