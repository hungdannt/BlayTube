...
import org.blayboy.newpipe.util.ListHelper;
...
import org.blayboy.newpipe.util.ShareUtils;
import org.blayboy.newpipe.views.ExpandableSurfaceView;
import org.blayboy.newpipe.DownloaderImpl;
import org.blayboy.newpipe.MainActivity;
import org.blayboy.newpipe.R;
import org.blayboy.newpipe.databinding.PlayerBinding;
import org.blayboy.newpipe.databinding.PlayerPopupCloseOverlayBinding;
import org.schabi.newpipe.extractor.MediaFormat;
import org.schabi.newpipe.extractor.stream.StreamInfo;
import org.schabi.newpipe.extractor.stream.StreamSegment;
import org.schabi.newpipe.extractor.stream.VideoStream;
import org.blayboy.newpipe.fragments.OnScrollBelowItemsListener;
import org.blayboy.newpipe.fragments.detail.VideoDetailFragment;
import org.blayboy.newpipe.info_list.StreamSegmentAdapter;
import org.blayboy.newpipe.ktx.AnimationType;
import org.blayboy.newpipe.local.history.HistoryRecordManager;
import org.blayboy.newpipe.player.MainPlayer.PlayerType;
import org.blayboy.newpipe.player.event.PlayerEventListener;
import org.blayboy.newpipe.player.event.PlayerGestureListener;
import org.blayboy.newpipe.player.event.PlayerServiceEventListener;
import org.blayboy.newpipe.player.helper.AudioReactor;
import org.blayboy.newpipe.player.helper.LoadController;
import org.blayboy.newpipe.player.helper.MediaSessionManager;
import org.blayboy.newpipe.player.helper.PlaybackParameterDialog;
import org.blayboy.newpipe.player.helper.PlayerDataSource;
import org.blayboy.newpipe.player.helper.PlayerHelper;
import org.blayboy.newpipe.player.playback.CustomTrackSelector;
import org.blayboy.newpipe.player.playback.MediaSourceManager;
import org.blayboy.newpipe.player.playback.PlaybackListener;
import org.blayboy.newpipe.player.playback.PlayerMediaSession;
import org.blayboy.newpipe.player.playqueue.PlayQueue;
import org.blayboy.newpipe.player.playqueue.PlayQueueAdapter;
import org.blayboy.newpipe.player.playqueue.PlayQueueItem;
import org.blayboy.newpipe.player.playqueue.PlayQueueItemBuilder;
import org.blayboy.newpipe.player.playqueue.PlayQueueItemHolder;
import org.blayboy.newpipe.player.playqueue.PlayQueueItemTouchCallback;
import org.blayboy.newpipe.player.resolver.AudioPlaybackResolver;
import org.blayboy.newpipe.player.resolver.MediaSourceTag;
import org.blayboy.newpipe.player.resolver.VideoPlaybackResolver;
import org.blayboy.newpipe.util.DeviceUtils;
import org.blayboy.newpipe.util.ImageDisplayConstants;
import org.blayboy.newpipe.util.KoreUtil;
import org.blayboy.newpipe.util.ListHelper;
...
import static org.blayboy.newpipe.ktx.ViewUtils.animateRotation;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_CLOSE;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_FAST_FORWARD;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_FAST_REWIND;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_PLAY_NEXT;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_PLAY_PAUSE;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_PLAY_PREVIOUS;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_RECREATE_NOTIFICATION;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_REPEAT;
import static org.blayboy.newpipe.player.MainPlayer.ACTION_SHUFFLE;
import static org.blayboy.newpipe.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_BACKGROUND;
import static org.blayboy.newpipe.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_NONE;
import static org.blayboy.newpipe.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
import static org.blayboy.newpipe.player.helper.PlayerHelper.buildCloseOverlayLayoutParams;
import static org.blayboy.newpipe.player.helper.PlayerHelper.formatSpeed;
import static org.blayboy.newpipe.player.helper.PlayerHelper.getMinimizeOnExitAction;
import static org.blayboy.newpipe.player.helper.PlayerHelper.getMinimumVideoHeight;
import static org.blayboy.newpipe.player.helper.PlayerHelper.getTimeString;
import static org.blayboy.newpipe.player.helper.PlayerHelper.globalScreenOrientationLocked;
import static org.blayboy.newpipe.player.helper.PlayerHelper.isPlaybackResumeEnabled;
import static org.blayboy.newpipe.player.helper.PlayerHelper.nextRepeatMode;
import static org.blayboy.newpipe.player.helper.PlayerHelper.nextResizeModeAndSaveToPrefs;
import static org.blayboy.newpipe.player.helper.PlayerHelper.retrievePlaybackParametersFromPrefs;
import static org.blayboy.newpipe.player.helper.PlayerHelper.retrievePlayerTypeFromIntent;
import static org.blayboy.newpipe.player.helper.PlayerHelper.retrievePopupLayoutParamsFromPrefs;
import static org.blayboy.newpipe.player.helper.PlayerHelper.retrieveSeekDurationFromPreferences;
import static org.blayboy.newpipe.player.helper.PlayerHelper.savePlaybackParametersToPrefs;
import static org.blayboy.newpipe.util.ListHelper.getPopupResolutionIndex;
import static org.blayboy.newpipe.util.ListHelper.getResolutionIndex;
import static org.blayboy.newpipe.util.Localization.assureCorrectAppLanguage;
import static org.blayboy.newpipe.util.Localization.containsCaseInsensitive;
...
public final class Player implements
    ...
    private void onTextTracksChanged() {
        ...
        if (trackSelector.getParameters().getRendererDisabled(textRenderer)
                ...
                && !Localization.containsCaseInsensitive(availableLanguages, preferredLanguage))) {
