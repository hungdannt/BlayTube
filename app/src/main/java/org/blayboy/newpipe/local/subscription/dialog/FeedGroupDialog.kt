...
import org.blayboy.newpipe.databinding.DialogFeedGroupCreateBinding
import org.blayboy.newpipe.databinding.ToolbarSearchLayoutBinding
import org.blayboy.newpipe.fragments.BackPressable
import org.blayboy.newpipe.local.subscription.FeedGroupIcon
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialog.ScreenState.DeleteScreen
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialog.ScreenState.IconPickerScreen
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialog.ScreenState.InitialScreen
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialog.ScreenState.SubscriptionsPickerScreen
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.ProcessingEvent
import org.blayboy.newpipe.local.subscription.dialog.FeedGroupDialogViewModel.DialogEvent.SuccessEvent
import org.blayboy.newpipe.local.subscription.item.EmptyPlaceholderItem
import org.blayboy.newpipe.local.subscription.item.PickerIconItem
import org.blayboy.newpipe.local.subscription.item.PickerSubscriptionItem
