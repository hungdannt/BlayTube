package org.blayboy.newpipe.streams;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import org.blayboy.newpipe.streams.WebMReader.Cluster;
import org.blayboy.newpipe.streams.WebMReader.Segment;
import org.blayboy.newpipe.streams.WebMReader.SimpleBlock;
import org.blayboy.newpipe.streams.WebMReader.WebMTrack;
import org.blayboy.newpipe.streams.io.SharpStream;
...
public class OggFromWebMWriter implements Closeable {
    ...
    private WebMReader.WebMTrack webmTrack = null;
    private WebMReader.Segment webmSegment = null;
    private WebMReader.Cluster webmCluster = null;
    private WebMReader.SimpleBlock webmBlock = null;
    ...
    public WebMReader.WebMTrack[] getTracksFromSource() throws IllegalStateException {
        if (!parsed) {
    ...
    @Nullable
    private WebMReader.SimpleBlock getNextBlock() throws IOException {
        WebMReader.SimpleBlock res;
    ...
    private boolean addPacketSegment(final WebMReader.SimpleBlock block) {
